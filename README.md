<div align="center">
<img src="https://ali-rezaali.github.io/src/assets/Images/Official%20Banner.jpg" alt="Ali Rezaali — Official Banner" width="100%" />
---
...
**Rezaali, A.** and Pilehforooshha, P. (2026). *Impact of the 2025 California Wildfires on Mountain Lion (Puma concolor) Habitat: A Remote Sensing and Species Distribution Modeling Framework.* ISPRS Annals of the Photogrammetry, Remote Sensing and Spatial Information Sciences, X-4/W8-2025, 609–616.
[doi.org/10.5194/isprs-annals-X-4-W8-2025-609-2026](https://doi.org/10.5194/isprs-annals-X-4-W8-2025-609-2026)

**Rezaali, A.**, Ebadi, H., and Farhadi, H. (2025). *Detection and Monitoring of Water Body Changes Using Innovative Thresholding of Spectral Indices (Case Study: Gorgan Gulf and Miankaleh Wetland).* Scientific-Research Quarterly of Geographical Data (SEPEHR), 34(134), 33–60.
[doi.org/10.22131/sepehr.2024.2041037.3096](https://doi.org/10.22131/sepehr.2024.2041037.3096)

**Rezaali, A.**, Ebadi, H., and Farhadi, H. (2025). *Monitoring Spatiotemporal Changes of Water Bodies Using Remote Sensing Data in Google Earth Engine (Case Study: Lake Urmia).* Journal of Geomatics Science and Technology (JGST), 14(3), 6.
[doi.org/10.61186/jgst.14.3.69](https://doi.org/10.61186/jgst.14.3.69)

**Rezaali, A.** (2024). *Time Series Monitoring of the Surface Water Body Changes Using Remote Sensing Satellite Imagery in Google Earth Engine (Case Study: Iran).* B.Sc. Thesis, K. N. Toosi University of Technology.
[doi.org/10.5281/zenodo.22727244](https://doi.org/10.5281/zenodo.22727244)

Full, up-to-date list on [Google Scholar](https://scholar.google.com/citations?user=e4ge-98AAAAJ&hl=en) and [ORCID](https://orcid.org/0009-0008-9387-5661).
...
![SHAP](https://img.shields.io/badge/-SHAP-8A2BE2)

**GIS & Photogrammetry**
![QGIS](https://img.shields.io/badge/-QGIS-589632?logo=qgis&logoColor=white)
![ArcGIS Pro](https://img.shields.io/badge/-ArcGIS_Pro-2C7AC3)
![ENVI](https://img.shields.io/badge/-ENVI-black)
![AgiSoft Metashape](https://img.shields.io/badge/-AgiSoft_Metashape-grey)

**WebGIS & Databases**
![PostGIS](https://img.shields.io/badge/-PostgreSQL%2FPostGIS-336791?logo=postgresql&logoColor=white)
![Leaflet](https://img.shields.io/badge/-Leaflet-199900?logo=leaflet&logoColor=white)

**Data Sources**
Sentinel-1/2 · Landsat 8/9 · VIIRS (NTL/LST) · MODIS · ERA5-Land · WorldClim/Bioclim · CHIRPS · LiDAR · ALOS DSM · SRTM DEM

---

## Contact

📍 Tehran, Iran · ✉️ [AliRezaaliGeo@gmail.com](mailto:AliRezaaliGeo@gmail.com)
